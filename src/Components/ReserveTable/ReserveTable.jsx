...
const ReserveTable = () => {
  return (
    <div className="reserve-table-container d-flex flex-column">
      ...
      <PageHeader
        bgImg="https://infatuation.imgix.net/media/images/guides/dark-chicago-restaurant-power-rankings/Izakaya_sandynoto.jpg"
        title="Reservation"
        description="If you have a food allergy, intolerance or sensitivity, please speak to your server about ingredients in our dishes before you order your meal."
      />
      ...
      <div className="reserve-form-container d-flex flex-column">
        ...
        <p className="rt-content">
          Etiam porta gravida nisl, in dictum felis consectetur in. Praesent vel
          purus sed enim luctus vehicula nec et erat. Aenean porttitor tellus eu
          nunc placerat blandit.
        </p>
